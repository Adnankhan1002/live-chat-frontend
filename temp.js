                  ...
                  <div className="p-5 flex flex-col flex-1 relative mt-[-32px]">
                    ...
                    <div className="mt-auto pt-4 flex items-center gap-2 border-t border-slate-50">
                      <button onClick={() => {
                        ...
                        axios.put("http://localhost:5050/chat/joinGroup", { chatId: group._id, userId: userData.data.id }, config);
                      }} className="flex-1 h-10 bg-indigo-500 hover:bg-indigo-600 text-white rounded-xl text-sm font-semibold transition-colors shadow-sm shadow-indigo-500/20">Join Group</button>
                    </div>
                  </div>
                </motion.div>
              );
